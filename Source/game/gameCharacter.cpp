...
void AgameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AgameCharacter::OnResetVR);
}


void AgameCharacter::OnResetVR()
{
	// If game is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in game.Build.cs is not automatically propagated
